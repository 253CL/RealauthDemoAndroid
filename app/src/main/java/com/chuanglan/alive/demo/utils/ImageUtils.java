...
public class ImageUtils {
    ...
    private static final String TAG = "CameraExif<TAG->";
    ...
    public static int getOrientation(byte[] jpeg) {
        ...
        if (length > 8) {
            ...
            if (tag != 0x49492A00 && tag != 0x4D4D002A) {
                LogTool.e(TAG, "Invalid byte order");
                return 0;
            }
        ...
        LogTool.i(TAG, "Orientation not found");
        return 0;
    }
    ...
    public static void resize(String inputPath, String outputPath, int dstWidth, int dstHeight, int quality) {
        try {
            ...
            if (rotation != 0) {
                m.preRotate((float) ExifUtils.exifToDegrees(rotation));
            }
