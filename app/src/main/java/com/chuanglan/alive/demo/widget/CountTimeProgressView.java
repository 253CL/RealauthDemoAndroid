...
public class CountTimeProgressView extends View implements View.OnClickListener {
    ...
    private final static String TAG = "CountTimeProgressView<TAG->";
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTitleCenter = attributes.getString(R.styleable.CountTimeProgressView_titleCenterText);
        ...
        mBackgroundColor = attributes.getColor(R.styleable.CountTimeProgressView_backgroundColorCenter, mBackgroundColor);
        // 起始位置角度
        mStartAngle = (attributes.getInteger(R.styleable.CountTimeProgressView_startAngle, mStartAngle) + 270) % 360;
        ...
        mCountTime = attributes.getInteger(R.styleable.CountTimeProgressView_countTime, 30);
        attributes.recycle();
...
//                displayText = (int) (mCountTime * (1 - mCurrentValue) / 1000) + "s";
                if (mTitleCenter != null && mTitleCenter.contains("%")) {
